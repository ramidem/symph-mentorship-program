  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>willing to guide and advise mentees</strong>
        {' '}
        on their careers and has the capacity to
        <strong>meet with them frequently</strong>
        {' '}
        according to the schedule they set at the start of the mentorship program. Mentors are also
        <strong>distinguished individuals</strong>
        {' '}
        in the community who made amazing
        <strong>contributions</strong>
        {' '}
        and continued to make great impacts in each of their fields. Most mentors were
        <strong>nominated </strong>
        {' '}
        by people interested to be their mentees.
      </p>
    </>
  );
}
